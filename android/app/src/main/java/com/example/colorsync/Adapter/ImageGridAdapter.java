...
public class ImageGridAdapter extends  RecyclerView.Adapter<ImageGridAdapter.ImageViewHolder> {
    ...
    public ImageGridAdapter(List<ImageData> items, int padding, boolean edit) {
        this.items = items;
    ...
    public static class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ImageData imageData, boolean edit) {
            this.item = imageData;

            imageView.setOnClickListener(view -> MainActivity.getInstance().setFullscreenImage(imageView, item, edit));
